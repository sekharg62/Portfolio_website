...
export function Experience() {
  return (
    <section id="experience" className="bg-slate-50/60 section-wrap">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {EXPERIENCE.map((exp, idx) => {
            ...
            return (
              ...
              >
                {/* Timeline dot */}
                <div className="absolute left-6 md:left-1/2 w-3 h-3 rounded-full bg-teal-500 ring-4 ring-teal-50 -translate-x-1.5 md:-translate-x-1.5 mt-6 z-10" />
                ...
                <div className={`flex-1 ml-10 md:ml-0 ${isLeft ? 'md:pl-10' : 'md:pr-10'}`}>
                  <div className="card group hover:border-teal-100">
                    {/* Top row */}
                    <div className="flex items-start justify-between gap-3 mb-4">
                      <div>
                        <h3 className="text-lg font-bold text-slate-900 group-hover:text-teal-700 transition-colors mb-0.5">
                          {exp.position}
                        </h3>
